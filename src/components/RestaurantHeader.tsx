    ...
    <div className="relative">
      ...
      >
        <div className="container relative flex flex-col justify-end h-full px-4 pb-6 mx-auto text-white">
          <h1 className="text-3xl font-bold md:text-4xl">Snack Grand Atlas</h1>
          ...
          <p className="max-w-xl mt-2 text-sm opacity-90">
            Authentic Moroccan flavors with a modern twist. A famous dining spot in Marrakech offering a wide selection of dishes prepared with fresh local ingredients.
          </p>
        </div>
      </div>
    </div>
